...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/a-propos' | '/confirmation' | '/contact' | '/mentions-legales' | '/offre-pro'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/a-propos' | '/confirmation' | '/contact' | '/mentions-legales' | '/offre-pro'
  id: '__root__' | '/' | '/a-propos' | '/confirmation' | '/contact' | '/mentions-legales' | '/offre-pro'
