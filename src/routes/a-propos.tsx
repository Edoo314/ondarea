...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      { title: "À propos — Ondarea" },
      { name: "description", content: "Edouard de Dreuzy, fondateur d'Ondarea. Entrepreneur passionné par l'Histoire, il collecte les mémoires familiales avant qu'elles ne disparaissent." },
      { property: "og:title", content: "À propos — Ondarea" },
      { property: "og:description", content: "L'histoire derrière Ondarea." },
    ],
  }),
  component: APropos,
});
        ...
        <div className="mt-16 grid gap-16 md:grid-cols-[1fr_2fr]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5 leading-relaxed text-muted-foreground">
              <p>
                Entrepreneur passionné par l'Histoire, j'ai fondé Ondarea avec
              ...
              <p>
                Ondarea est né de ce constat. Aller collecter ces mémoires,
            ...
            <div className="border-t border-ink/15 pt-8">
              ...
              <a
                href="mailto:bonjour@ondarea.fr"
